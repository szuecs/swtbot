 ...
 * @since 2.0
 */
public class WithPerspectiveLabel extends
		AbstractMatcher<IPerspectiveDescriptor> {

	private final Matcher<String> labelMatcher;

	/**
	 * @param labelMatcher
	 *            the perspective label matcher.
	 */
	...
	public void describeTo(Description description) {
		description.appendText("with label '")
				.appendDescriptionOf(labelMatcher).appendText("'");
	}
	 ...
	 */
	@Factory
	public static WithPerspectiveLabel withPerspectiveLabel(
			Matcher<String> labelMatcher) {
