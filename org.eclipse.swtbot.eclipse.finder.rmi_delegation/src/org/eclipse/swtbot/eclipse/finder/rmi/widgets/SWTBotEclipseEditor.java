...
import org.eclipse.swtbot.eclipse.finder.rmi.SWTWorkbenchBot;
...
public class SWTBotEclipseEditor extends SWTBotEditor {
	 ...
	 */
	public void quickfix(int quickFixIndex) throws RemoteException {
	 ...
	 * @since 1.2
	 */
	public List<String> getQuickFixes() throws RemoteException {
		WaitForObjectCondition<SWTBotTable> quickFixTableCondition = quickFixAppears(any(SWTBotTable.class));
		waitUntil(quickFixTableCondition);
		SWTBotTable quickFixTable = quickFixTableCondition.get(0);
	 ...
	 * @since 1.2
	 */
	public int getQuickfixListItemCount() throws RemoteException {
		WaitForObjectCondition<SWTBotTable> quickFixTableCondition = quickFixAppears(any(SWTBotTable.class));
		waitUntil(quickFixTableCondition);
		SWTBotTable quickFixTable = quickFixTableCondition.get(0);
