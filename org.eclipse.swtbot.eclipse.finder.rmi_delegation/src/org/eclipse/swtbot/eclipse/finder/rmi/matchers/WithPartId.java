 ...
 * @since 2.0
 */
public class WithPartId<T extends IWorkbenchPartReference> extends
		AbstractMatcher<T> {
	...
	public void describeTo(Description description) {
		description.appendText("with id '").appendDescriptionOf(idMatcher)
				.appendText("'");
	}
	 ...
	 */
	@Factory
	public static <T extends IWorkbenchPartReference> Matcher<T> withPartId(
			String id) {
