 ...
 * @version $Id$
 */
public class SWTBotView extends SWTBotWorkbenchPart<IViewReference> implements
		Serializable {

	private static final long serialVersionUID = -8997637681030793871L;

	/**
	 * Creates an instance of a view part.
	 * 
	 * @param partReference
	 *            the view reference representing this view.
	 * @param bot
	 *            the bot that's used to find controls within this view.
	 * @since 2.0
	 */
	public SWTBotView(IViewReference partReference, RmiSWTWorkbenchBot bot) {
