...
public class WorkbenchContentsFinder {
	...
	/**
	 * @param matcher
	 *            the matcher used to match editors.
	...
	/**
	 * @param matcher
	 *            the matcher used to match perspectives
	 * @return the list of matching perspectives
	 */
	public List<IPerspectiveDescriptor> findPerspectives(
			final Matcher<?> matcher) {
		return syncExec(SWTUtils.display(),
				new ListResult<IPerspectiveDescriptor>() {
	...
	private List<IPerspectiveDescriptor> findPerspectivesInternal(
			final Matcher<?> matcher) {
		IPerspectiveDescriptor[] perspectives = activeWorkbenchWindow()
	...
	private IViewReference findActiveViewInternal() {
		IWorkbenchPartReference partReference = activePageInternal()
