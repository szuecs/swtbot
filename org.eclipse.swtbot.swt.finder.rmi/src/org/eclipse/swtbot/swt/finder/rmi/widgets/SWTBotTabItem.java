...
public class SWTBotTabItem extends AbstractSWTBot<TabItem> implements
		Serializable {

	private static final long serialVersionUID = 7795062517421540679L;
	 ...
	 *             disposed.
	 */
	public SWTBotTabItem(TabItem w, SelfDescribing description)
			throws WidgetNotFoundException {
		super(w, description);
