...
public class SWTBotCheckBox extends AbstractSWTBotControl<Button> implements
		Serializable {

	private static final long serialVersionUID = -3111331258945516224L;
	 ...
	 * @since 1.0
	 */
	public SWTBotCheckBox(Button w, SelfDescribing description)
			throws WidgetNotFoundException {
		super(w, description);
	 ...
	 * 
	 * @return <code>true</code> if the checkbox is checked. Otherwise
	 *         <code>false</code>.
	 */
