 ...
 * @version $Id$
 */
@SWTBotWidget(clasz = Text.class, preferredName = "text", referenceBy = {
		ReferenceBy.LABEL, ReferenceBy.TEXT, ReferenceBy.TOOLTIP })
public class SWTBotText extends AbstractSWTBot<Text> implements Serializable {

	private static final long serialVersionUID = -6283262093389316694L;
	 ...
	 *             disposed.
	 */
	public SWTBotText(Text w, SelfDescribing description)
			throws WidgetNotFoundException {
		super(w, description);
	}
