 ...
 * @version $Id$
 */
@SWTBotWidget(clasz = Slider.class, preferredName = "slider", referenceBy = {
		ReferenceBy.LABEL, ReferenceBy.TEXT, ReferenceBy.TOOLTIP })
public class SWTBotSlider extends AbstractSWTBot<Slider> implements
		Serializable {

	private static final long serialVersionUID = -7453490081452017580L;
	 ...
	 *             disposed.
	 */
	public SWTBotSlider(Slider widget, SelfDescribing description)
			throws WidgetNotFoundException {
	 ...
	 * 
	 * @param value
	 *            the value to set into the slider.
	 */
	public void setSelection(final int value) {
		log.debug(MessageFormat.format(
				"Setting selection on {0} to {1}", this, value)); //$NON-NLS-1$
		assertEnabled();
		...
		log.debug(MessageFormat.format(
				"Set selection on {0} to {1}", this, value)); //$NON-NLS-1$
	}
