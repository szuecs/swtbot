...
public class SWTBotRadio extends AbstractSWTBotControl<Button> implements
		Serializable {

	private static final long serialVersionUID = -6380730990601514225L;
	 ...
	 *             disposed.
	 */
	public SWTBotRadio(Button w, SelfDescribing description)
			throws WidgetNotFoundException {
		super(w, description);
	 ...
	 * 
	 * @return <code>true</code> if the radio button is selected. Otherwise
	 *         <code>false</code>.
	 */
