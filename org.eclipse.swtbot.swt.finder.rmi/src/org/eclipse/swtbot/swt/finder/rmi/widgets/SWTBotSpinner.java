 ...
 * @version $Id$
 */
@SWTBotWidget(clasz = Spinner.class, preferredName = "spinner", referenceBy = {
		ReferenceBy.LABEL, ReferenceBy.TEXT, ReferenceBy.TOOLTIP })
public class SWTBotSpinner extends AbstractSWTBot<Spinner> implements
		Serializable {

	private static final long serialVersionUID = 2951075412959661338L;
	 ...
	 * 
	 * @param value
	 *            the value to set into the spinner.
	 */
