...
public class SWTBotCLabel extends AbstractSWTBotControl<CLabel> implements
		Serializable {

	private static final long serialVersionUID = -7735458706012810876L;
	 ...
	 * @since 2.0
	 */
	public SWTBotCLabel(CLabel w, SelfDescribing description)
			throws WidgetNotFoundException {
		super(w, description);
	}
