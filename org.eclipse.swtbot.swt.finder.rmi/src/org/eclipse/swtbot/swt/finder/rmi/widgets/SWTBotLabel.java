...
public class SWTBotLabel extends AbstractSWTBotControl<Label> implements
		Serializable {

	private static final long serialVersionUID = -276246696603071278L;

	/**
	 * Constructs an instance of this using the given finder and text to search
	 * for.
	 * 
	 * @param widget
	 *            the widget
	 * @throws WidgetNotFoundException
	 *             if the widget is null or disposed.
	 */
	 ...
	 *             if the widget is null or disposed.
	 */
	public SWTBotLabel(Label widget, SelfDescribing description)
			throws WidgetNotFoundException {
