...
public class SWTBotShell extends AbstractSWTBotControl<Shell> implements
		Serializable {

	/**
	 * Remote
	 */
	private static final long serialVersionUID = -1330896126390884152L;
	 ...
	 *             disposed.
	 */
	public SWTBotShell(Shell shell, SelfDescribing description)
			throws WidgetNotFoundException {
	...
	// return shell;
	// }
	// throw new WidgetNotFoundException("Cound not find shell matching text:" +
	// text);
	// }
	 ...
	 *             if the shell could not be activated
	 */
	...
	public void close() throws TimeoutException {
		...
		asyncExec(new VoidResult() {
			public void run() {
				...
				// https://bugs.eclipse.org/bugs/show_bug.cgi?id=259895
	 ...
	 * 
	 * @return <code>true</code> if the shell is visible, <code>false</code>
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return <code>true</code> if the shell is active, <code>false</code>
	 *         otherwise.
	 */
