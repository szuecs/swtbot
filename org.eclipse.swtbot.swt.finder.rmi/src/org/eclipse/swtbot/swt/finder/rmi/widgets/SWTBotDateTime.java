...
public class SWTBotDateTime extends AbstractSWTBotControl<DateTime> implements
		Serializable {

	private static final long serialVersionUID = 7809215085343637514L;
	 ...
	 * @since 2.0
	 */
	public SWTBotDateTime(DateTime w, SelfDescribing description)
			throws WidgetNotFoundException {
		super(w, description);
	}
	 ...
	 * 
	 * @param toSet
	 *            the date to set into the control.
	 */
	public void setDate(final Date toSet) {
		log.debug(MessageFormat.format(
				"Setting date on control: {0} to {1}", this, toSet)); //$NON-NLS-1$
		assertEnabled();
