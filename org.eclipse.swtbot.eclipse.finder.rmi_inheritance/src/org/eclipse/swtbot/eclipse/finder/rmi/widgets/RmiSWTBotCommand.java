 ...
 * @since 1.2
 */
public class RmiSWTBotCommand extends SWTBotCommand {
	 ...
	 */
	public RmiSWTBotCommand(Command command) throws WidgetNotFoundException {
		super(command);
	...
	public void click() throws WidgetNotFoundException {
		if (commandID != null) {
			...
			throw new WidgetNotFoundException(
					"The command to could not be execute due to the lack of an ID."); //$NON-NLS-1$
	}
	 ...
	 * @throws WidgetNotFoundException
	 *             Thrown if the command name has not been defined.
	 */
